...
The metaverse loader is intended to be driven by a server framework (like vite.js/rollup.js), and game engine client (like Upstreet) to provide a complete immersive world (or metaverse) to the user.
