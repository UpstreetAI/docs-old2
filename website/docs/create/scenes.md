...
First need to download and install the app repo locally from: https://github.com/upstreetai/upstreet.ai

```
$ git clone https://github.com/upstreetai/upstreet.ai.git
$ cd app/
$ npm run install
$ node index
```
...
$ git clone https://github.com/upstreetai/party.git
```
