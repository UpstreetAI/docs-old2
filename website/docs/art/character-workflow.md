...
![](https://i.imgur.com/pa5kwIh.jpg)

### Blender
* [Download Blender](https://www.blender.org/download/) ![](https://i.imgur.com/ci4ctnb.jpg)

* Install and run!

* **Required Blender addons**

  * [CATS Blender Plugin](https://github.com/GiveMeAllYourCats/cats-blender-plugin) ![](https://i.imgur.com/jav8XrW.jpg)

  * [VRM Addon for Blender](https://github.com/saturday06/VRM_Addon_for_Blender) ![](https://i.imgur.com/jav8XrW.jpg)
...
* **!** `Click the 3 bar icon in the bottom left` ![](https://i.imgur.com/ob7j5QS.jpg)
...
![](https://i.imgur.com/WvgrL8v.jpg)  

![](https://i.imgur.com/LLDJfyq.jpg)  
...
By default, VRoid models have quite a high material count - one of the goals of Upstreet's content is that it is lightweight in filesize and performance draw - thankfully we can easily reduce the material count here before we export it.
...
Repeat this for every blendshape in this list if you want your avatar to have the full range of facial expressions. Upstreet, on the other hand, only requires the following blendshapes.

![](/img/bldr_vrm_export11.jpg)

The ones crossed out in red are not required for Upstreet.
...
![](/img/bldr_vrm_export10.jpg)

The First person bone offset values should be the point between your character's eyes. The default values are enough for Upstreet.

![](/img/bldr_vrm_export1.jpg)
...
![](https://i.imgur.com/WqpHXgV.jpg)

It should then reflect that your vertex group is hidden!

![](https://i.imgur.com/ZrTWiTv.jpg)
...
Your scene will look something like this - avatar mesh, and armature: ![](https://i.imgur.com/Wo5yzHK.jpg)
...
![](https://i.imgur.com/TP5NAqC.jpg)

Click the dropdown for Shader.

For MToon, select VRM > MToon.

![](https://i.imgur.com/xux8JtZ.jpg)
...
![](https://i.imgur.com/iFIG8j9.jpg)


![](https://i.imgur.com/NPCug3B.jpg)
...
Before you click Export, go to the ExportSettings tab in the VRM Exporter window. For Upstreet we strongly suggest using “Reduce Blendshape”, and “Reduce Blendshape Clip” export settings. These will remove any unused blendshapes from the VRM file and can dramatically reduce file size. You can safely enable “Only Blendshape Position” and “Divide Vertex Buffer” If the warnings do not apply to your avatar. These options do not affect Upstreet.

**If you enable “Use Sparse Accessor'' it will cause errors. Do not enable this option if you intend to use your avatar for Upstreet.**
...
Presto! You have successfully converted and saved your avatar as a VRM. This final VRM that you just exported is what you will use in Upstreet.

#### Alternate Methods

[Converting an FBX Avatar to VRM](https://hackmd.io/@metamike/fbx-vrm-upstreet#Oveview)
